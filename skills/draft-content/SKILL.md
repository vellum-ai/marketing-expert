...
### Step 5: Deliver + offer follow-ups
Output the draft (with the headline options up top). Then offer: a **brand-voice** check, repurposing via **content-engine**, or — for email flows — designing the full sequence with **email-sequence**.
